...
public class BasicCannon : Weapon {
    ...
    void TryShoot() {
        ...
        if (currCooldown>= attacksPerSecond) {
            ...
            Projectile newProjectile = Instantiate(usedProjectile, bulletSpawnpoint.position, bulletSpawnpoint.rotation);
            newProjectile.InitialiseBullet(trackedEnemy.transform);
            currCooldown = 0;
